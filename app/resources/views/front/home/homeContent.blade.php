...
<div class="jumbotron text-center"style="background: #8eeaff;" >
  ...
  <a href="{{url('/')}}" type="submit" class="btn btn-primary">home</a>
  <h1>Wallet</h1>
  
     <a href="#"  class="btn btn-primary">৳ {{$user->useramount}}</a>
</div>
  
<div class="container">

 <h1>Money Transfer</h1>
<form id="basic-form-wizard" action="{{url('/send')}}" method="post">
                                            {{csrf_field() }}
